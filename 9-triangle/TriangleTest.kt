...
class TriangleTest {
    ...
    @Test
    fun `degenerate - last is equal sum of others`() {
        assertTrue(Triangle(1, 2, 3).isDegenerate)
    }

    @Test
    fun `degenerate - second is equal sum of others`() {
        assertTrue(Triangle(1, 3, 2).isDegenerate)
    }

    @Test
    fun `degenerate - first is equal sum of others`() {
        assertTrue(Triangle(3, 1, 2).isDegenerate)
    }
}
