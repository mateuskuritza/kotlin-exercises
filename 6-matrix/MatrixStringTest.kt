...
class MatrixStringTest {
    ...
    fun `extract row from one number matrix`() {
        ...
        assertEquals(expectedRow, MatrixString(matrixAsString).row(rowIndex))
    }
    ...
    fun `extract column from one number matrix`() {
        ...
        assertEquals(expectedColumn, MatrixString(matrixAsString).column(columnIndex))
    }
